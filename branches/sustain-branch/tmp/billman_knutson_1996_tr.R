 # fit Logical Structure of Stimulus Items from Billman and Knutson (1996)
 # as it was described in Table 8 in Love, Meding and Gureckis (2004)
...
.conversion <- function(x) {
 ...
 # Nonintercorrelated
non2 <- matrix(c(1, 2, 3, 1, 2, 3, rep(0, 15)),
                 ncol = 7, nrow = 3)
