...
** Creating krus96train
- catlearn style rules - max column width 80, use spaces to separate code wihtin a line 

- trainingitems line can be coded more simply, see code.
